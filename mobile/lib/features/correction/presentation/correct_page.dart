...
class _CorrectPageState extends ConsumerState<CorrectPage> {
          ...
          children: [
            ...
            if (isAudio) ...[
              _TimestampSection(
                ...
                onRemove: (i) => setState(() => _timestampComments.removeAt(i)),
  ...
  Future<void> _startRefRecording() async {
    try {
  ...
  Future<void> _submit({required bool isAudioRequest}) async {
    ...
    ref
        ...
        .submit(
          ...
          fluencyScore: isAudioRequest ? _fluencyScore : null,
          ...
          ...comments.asMap().entries.map((e) {
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  GestureDetector(
                    onTap: () => onSeek(Duration(milliseconds: tc.offsetMs)),
                    child: Text(
                      _fmt(tc.offsetMs),
                      style: theme.textTheme.labelSmall?.copyWith(
                        color: theme.colorScheme.primary,
